...
class create_model:
    ...
    def build_model(self):
        ...
        # kompilacja moddelu
        self.model.compile(loss='binary_crossentropy', optimizer=mc.optimizer, metrics=['accuracy'])

    def train_model(self):
        self.model.fit(self.X_train, self.y_train, validation_data=(self.X_test, self.y_test), epochs=mc.epoch, batch_size=64)
